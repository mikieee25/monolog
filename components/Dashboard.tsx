      ...
      <div className="flex flex-col w-full md:w-[320px] lg:w-[380px] shrink-0">
        ...
        <div className="md:hidden flex gap-2 overflow-x-auto px-5 pb-2 scrollbar-none">
          <button 
            ...
            className="flex items-center gap-2 whitespace-nowrap px-3 py-2 bg-zinc-100 dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-300 rounded-xl text-xs font-medium"
          >
          ...
          <ScanSubscriptionsButton className="whitespace-nowrap px-3 py-2 text-xs rounded-xl bg-zinc-100 dark:bg-zinc-900/80 border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-800/80" />
        </div>
        ...
        <div className="hidden md:flex flex-col gap-2 mt-4">
          ...
          <ScanSubscriptionsButton className="flex w-full items-center gap-3 px-4 py-3 bg-zinc-100 dark:bg-zinc-900/50 hover:bg-zinc-200 dark:hover:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-800/50 text-zinc-900 dark:text-zinc-300 rounded-xl font-medium transition-colors" />
        </div>
      </div>

      {/* Right Column (Desktop) / Bottom Section (Mobile) */}
      <div className="flex-1 px-5 md:p-8 flex flex-col md:bg-zinc-100/50 dark:md:bg-zinc-900/30 md:backdrop-blur-xl md:border border-zinc-200 dark:md:border-zinc-800/60 md:rounded-3xl md:shadow-2xl">
